...
.bar{flex:1;height:8px;max-width:56px;background:#000;border-radius:4px;overflow:hidden;margin-left:4px;border:2px solid #000;min-width:20px}
.fill{height:100%;transition:width 0.2s}
#questPanel{position:absolute;top:76px;right:6px;width:170px;max-width:42vw;background:linear-gradient(#4e342e,#2a1a14);border-radius:14px;padding:6px;border:4px solid #000;box-shadow:0 5px 0 #000;pointer-events:auto;max-height:28vh;overflow-y:auto;z-index:6}
...
#joystick{position:absolute;bottom:18px;left:14px;width:150px;height:150px;pointer-events:auto;z-index:5}
.joyBase{width:150px;height:150px;border-radius:75px;background:radial-gradient(circle at 30% 30%,#5a5a5a,#1a1a1a);border:5px solid #000;position:relative;box-shadow:0 7px 0 #000}
.joyStick{width:60px;height:60px;border-radius:30px;background:radial-gradient(circle at 30% 30%,#FFD700,#b8960c);border:4px solid #000;position:absolute;left:40px;top:40px;box-shadow:0 5px 0 #000;display:flex;justify-content:center;align-items:center}
.joyStick::after{content:'🕹️';font-size:24px}
...
#actionBtns{position:absolute;bottom:18px;right:12px;pointer-events:auto;display:flex;flex-direction:column;gap:12px;z-index:5}
.actBtn{width:68px;height:68px;min-width:68px;min-height:68px;border-radius:18px;border:4px solid #000;display:flex;flex-direction:column;justify-content:center;align-items:center;cursor:pointer;box-shadow:0 7px 0 #000;transition:transform 0.05s;position:relative}
.actBtn:active{transform:translateY(7px);box-shadow:0 0 0 #000}
.actBtn .icon{font-size:28px;line-height:1}
.actBtn .label{font-size:7px;font-weight:900;color:#fff;text-shadow:1px 1px 0 #000;margin-top:2px}
...
#spellsBar{position:absolute;bottom:18px;left:50%;transform:translateX(-50%);display:flex;gap:8px;pointer-events:auto;background:rgba(0,0,0,0.9);padding:7px 12px;border-radius:18px;border:4px solid #000;box-shadow:0 5px 0 #000;z-index:5}
.spell{width:56px;height:56px;min-width:56px;min-height:56px;background:linear-gradient(#3a3a4a,#1a1a2a);border:4px solid #000;border-radius:14px;display:flex;flex-direction:column;justify-content:center;align-items:center;cursor:pointer;position:relative;box-shadow:0 4px 0 #000;transition:transform 0.05s}
.spell:active{transform:translateY(4px);box-shadow:0 0 0 #000}
.spell.cooldown{opacity:0.35;filter:grayscale(1)}
.spellIcon{font-size:24px}
.spellKey{position:absolute;top:-10px;right:-10px;background:linear-gradient(#FFD700,#FFA500);color:#000;font-size:10px;font-weight:900;width:22px;height:22px;border-radius:11px;display:flex;justify-content:center;align-items:center;border:3px solid #000;box-shadow:0 2px 0 #000}
.spellMana{font-size:7px;font-weight:900;color:#64b5f6;position:absolute;bottom:2px}
...
.invTitle{color:#FFD700;font-weight:900;font-size:13px}
.invWeight{color:#a1887f;font-size:11px;font-weight:900;background:#000;padding:3px 8px;border-radius:10px;border:2px solid #5d4037}
...
.equipSlot{aspect-ratio:1;background:linear-gradient(#2a1a14,#1a0f0a);border:3px solid #5d4037;border-radius:10px;display:flex;flex-direction:column;justify-content:center;align-items:center;font-size:20px;cursor:pointer;position:relative;box-shadow:0 2px 0 #000;min-height:52px}
...
.gemDot{width:8px;height:8px;border-radius:4px;border:1px solid #000;box-shadow:0 1px 0 #000}
.invGrid{display:grid;grid-template-columns:repeat(5,1fr);gap:7px}
.invSlot{aspect-ratio:1;background:linear-gradient(#1e1e1e,#0a0a0a);border:3px solid #000;border-radius:10px;display:flex;justify-content:center;align-items:center;font-size:22px;cursor:pointer;position:relative;box-shadow:0 3px 0 #000;min-height:52px}
...
.invSlot .count{position:absolute;bottom:2px;right:4px;font-size:11px;font-weight:900;color:#FFD700;background:#000;padding:1px 5px;border-radius:10px;border:2px solid #FFD700}
.invActions{display:flex;gap:6px;margin-top:12px;flex-wrap:wrap}
.invBtn{flex:1;min-width:70px;height:48px;background:linear-gradient(#4a4a4a,#2a2a2a);border:4px solid #000;border-radius:12px;color:#fff;font-weight:900;font-size:10px;display:flex;justify-content:center;align-items:center;cursor:pointer;box-shadow:0 4px 0 #000;transition:transform 0.05s;letter-spacing:0.5px}
.invBtn:active{transform:translateY(4px);box-shadow:0 0 0 #000}
...
.gemSlot{aspect-ratio:1;background:linear-gradient(#1a1a1a,#0a0a0a);border:3px solid #5d4037;border-radius:12px;display:flex;flex-direction:column;justify-content:center;align-items:center;cursor:pointer;position:relative;box-shadow:0 3px 0 #000;min-height:64px;transition:transform 0.05s}
.gemSlot:active{transform:translateY(3px);box-shadow:0 0 0 #000}
...
.classCard{background:linear-gradient(#4a3a32,#2a1a14);border:4px solid #000;border-radius:16px;padding:12px;cursor:pointer;text-align:center;box-shadow:0 5px 0 #000;min-height:110px;display:flex;flex-direction:column;justify-content:center;transition:transform 0.05s;position:relative}
...
.startBtn{margin-top:14px;background:linear-gradient(#FFD700,#FF8f00);color:#000;border:5px solid #000;padding:16px 44px;border-radius:16px;font-weight:900;font-size:18px;cursor:pointer;box-shadow:0 7px 0 #000;letter-spacing:1.5px;min-width:240px;min-height:60px;transition:transform 0.05s}
...
.lootPopup{position:absolute;left:50%;top:45%;transform:translate(-50%,-50%);background:linear-gradient(#3e2723,#1a0f0a);border:5px solid #000;border-radius:16px;padding:14px;box-shadow:0 8px 0 #000;z-index:22;min-width:260px;max-width:90vw;text-align:center;animation:pop 0.4s cubic-bezier(0.34,1.56,0.64,1)}
...
#bossBar{position:absolute;top:76px;left:50%;transform:translateX(-50%);width:70%;max-width:300px;height:22px;background:#000;border:4px solid #000;border-radius:12px;display:none;pointer-events:none;z-index:9;box-shadow:0 3px 0 #000;overflow:hidden}
...
<div id="ui">
  ...
  <div id="joystick"><div class="joyBase" id="joyBase"><div class="joyStick" id="joyStick"></div></div><div class="joyLabel">MOVER • ARRASTE</div></div>
  <div id="actionBtns">
  ...
  <div id="spellsBar">
    <div class="spell" id="spell1"><div class="spellKey">1</div><div class="spellIcon">🔥</div><div class="spellMana">15</div></div>
    <div class="spell" id="spell2"><div class="spellKey">2</div><div class="spellIcon">❄️</div><div class="spellMana">15</div></div>
    ...
    <div class="charTop">
      ...
      <div class="charInfo">
        ...
        <div style="margin-top:6px;display:flex;gap:4px;flex-wrap:wrap">
          ...
          <span style="font-size:7px;background:#000;padding:2px 6px;border-radius:6px;border:2px solid #5d4037;color:#64b5f6;font-weight:900" id="charMana">MANA 100</span>
          <span style="font-size:7px;background:#000;padding:2px 6px;border-radius:6px;border:2px solid #5d4037;color:#4caf50;font-weight:900" id="charStats">Dmg 10 Def 5</span>
        </div>
      </div>
    </div>
...
function genGem(){
  let t=GEM_TYPES[Math.floor(Math.random()*GEM_TYPES.length)];
  return {id:'gem_'+Math.random().toString(36).substr(2,5),name:t.name,icon:t.icon,type:'gem',gemType:t.id,color:t.color,stats:{...t.stats},desc:t.desc,price:t.price,weight:1,count:1,rarity:'magic'};
}
...
function initInv(){
  inv=[
    ...
    {id:'potion_hp',name:'Poção Vida',icon:'🧪',type:'potion',rarity:'common',stats:{hp:50},count:5,weight:1,level:1},
    {id:'potion_mana',name:'Poção Mana',icon:'🔮',type:'potion',rarity:'common',stats:{mana:50},count:4,weight:1,level:1},
    genGem(), genGem(),
...
function genItem(slotType, rarity, lvl){
  ...
  let suf=Math.random()<0.5?SUFFIXES[Math.floor(Math.random()*SUFFIXES.length)]:null;
...
function genShopInventory(){
  let items=[];
  for(let i=0;i<4;i++){items.push(genItem(['weapon','head','chest','shield'][i%4],['magic','rare'][Math.floor(Math.random()*2)],act+Math.floor(Math.random()*2)));}
  for(let i=0;i<4;i++){items.push(genGem());}
  items.push({id:'potion_hp',name:'Poção Vida',icon:'🧪',type:'potion',rarity:'common',stats:{hp:50},count:1,weight:1,level:1,price:25});
  items.push({id:'potion_mana',name:'Poção Mana',icon:'🔮',type:'potion',rarity:'common',stats:{mana:50},count:1,weight:1,level:1,price:25});
  return items;
}

function genDungeon(actId){
  dungeonWalls=[]; objs=[]; mons=[]; chests=[]; merchants=[];
  inDungeon=true;
  let rooms=[]; let roomCount=5+actId;
  for(let i=0;i<roomCount;i++){
    let rw=200+Math.random()*200, rh=150+Math.random()*150; let rx=200+Math.random()*(W-rw-400), ry=200+Math.random()*(H-rh-400);
...
function rq(){
  ...
  quests.filter(q=>q.act===act && !q.done).slice(0,4).forEach(q=>{
...
function useItem(idx){
  ...
  if(it.id==='potion_hp'){P.hp=Math.min(P.maxHp,P.hp+it.stats.hp); it.count--; if(it.count<=0) inv[idx]={id:'empty',name:'',icon:'',type:'empty',count:0,weight:0}; updateBars(); ri(); showPopup(\`💚 +\${it.stats.hp} HP\`,'#4caf50');}
  if(it.id==='potion_mana'){P.mana=Math.min(P.maxMana,P.mana+it.stats.mana); it.count--; if(it.count<=0) inv[idx]={id:'empty',name:'',icon:'',type:'empty',count:0,weight:0}; updateBars(); ri(); showPopup(\`🔮 +\${it.stats.mana} MANA\`,'#42a5f5');}
}
...
function showPopup(text,color='#FFD700'){
  ...
  p.style.cssText=\`position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);background:linear-gradient(#3e2723,#1a0f0a);border:4px solid \${color};border-radius:12px;padding:10px 18px;font-weight:900;color:\${color};box-shadow:0 6px 0 #000;z-index:22;text-align:center;animation:pop 0.4s\`;
  p.textContent=text; document.getElementById('gc').appendChild(p); setTimeout(()=>p.remove(),1800);
}
...
function showLoot(item){
  ...
  d.querySelector('#lootEquip').onclick=()=>{if(addToInv(item)){if(!isGem){let idx=inv.findIndex(x=>x.id===item.id); if(idx>=0) equipItem(idx);} ri();} d.remove();};
  d.querySelector('#lootTake').onclick=()=>{addToInv(item); ri(); d.remove(); showPopup(\`📦 \${item.name}\`,'#42a5f5'); if(item.type==='gem'){quests.forEach(q=>{if(!q.done&&q.gem){q.progress++; if(q.progress>=q.total){q.done=1;P.gold+=q.r;document.getElementById('gold').textContent=P.gold; showPopup(\`✅ \${q.t}\`,'#FFD700');} rq();}});}};
...
function doAttack(){
  ...
  mons.forEach(m=>{
    ...
    if(dist<90){
      let tot=calcTotalStats();
      let dmg=10+Math.floor(P.attr.STR*0.8)+tot.dmg+Math.floor(Math.random()*6);
      ...
      if(m.hp<=0){
        ...
        let goldGain=10+act*5+Math.floor(Math.random()*10); P.gold+=goldGain; document.getElementById('gold').textContent=P.gold;
        let xpGain=15+act*5; P.xp+=xpGain; if(P.xp>=100){P.lvl++;P.xp-=100;P.attrPts+=3;P.skillPts+=1;P.maxHp+=CLASSES[P.cls].hp;P.maxMana+=CLASSES[P.cls].mana;P.hp=P.maxHp;P.mana=P.maxMana; updateBars(); showPopup(\`⬆️ LEVEL UP! Lv\${P.lvl}\`,'#FFD700'); updateCharScreen();}
        quests.forEach(q=>{if(!q.done&&q.killType&&m.type.includes(q.killType)){q.progress++; if(q.progress>=q.total){q.done=1;P.gold+=q.r;document.getElementById('gold').textContent=P.gold; showPopup(\`✅ \${q.t} +\${q.r} ouro\`,'#FFD700');} rq();}});
        if(m.isBoss){
          quests.forEach(q=>{if(!q.done&&q.isBoss&&q.act===act){q.progress=1;q.done=1;P.gold+=q.r;document.getElementById('gold').textContent=P.gold; showPopup(\`👑 BOSS DERROTADO! +\${q.r} ouro\`,'#FFD700'); if(q.final){showActTransition(5,true);} else if(act<5){setTimeout(()=>{act++; genWorld(); initQuests(); rq(); showActTransition(act);},1500);} rq();}});
          let loot=Math.random()<0.5?genItem('weapon',['rare','legendary'][Math.floor(Math.random()*2)],act+3):genGem();
          setTimeout(()=>showLoot(loot),800);
        } else if(Math.random()<0.4){
          let loot=Math.random()<0.25?genGem():genItem(['weapon','head','chest'][Math.floor(Math.random()*3)],Math.random()<0.7?'common':'magic',act+Math.floor(Math.random()*2));
          if(loot.type==='gem'){addToInv(loot); ri(); quests.forEach(q=>{if(!q.done&&q.gem){q.progress++; if(q.progress>=q.total){q.done=1;P.gold+=q.r;document.getElementById('gold').textContent=P.gold; showPopup(\`✅ \${q.t}\`,'#FFD700');} rq();}});}
  ...
  chests.forEach(ch=>{
    if(!ch.opened && Math.hypot(ch.x-P.x,ch.y-P.y)<70){
      ch.opened=true; showLoot(ch.loot);
      quests.forEach(q=>{if(!q.done&&q.chest){q.progress++; if(q.progress>=q.total){q.done=1;P.gold+=q.r;document.getElementById('gold').textContent=P.gold; showPopup(\`✅ \${q.t}\`,'#FFD700');} rq();}});
    }
  });
  merchants.forEach(mer=>{
    if(Math.hypot(mer.x-P.x,mer.y-P.y)<80){openShop();}
  });
  if(hit){document.getElementById('game').style.transform='translate(4px,0)'; setTimeout(()=>document.getElementById('game').style.transform='',70);}
}
...
function doSkill(id){
  ...
  if(id==='bash'||id==='holy'||id==='disease'){
    mons.forEach(m=>{if(m.alive&&Math.hypot(m.x-P.x,m.y-P.y)<100){let dmg=30+P.attr.INT+tot.fire+tot.light; m.hp-=dmg; particles.push({x:m.x,y:m.y-20,text:\`-\${dmg}\`,life:1,color:'#ff9800'}); if(m.hp<=0){m.alive=false;m.respawn=8;}}});
  }
  ...
  if(id==='frost'){
    mons.forEach(m=>{if(m.alive&&Math.hypot(m.x-P.x,m.y-P.y)<140){m.hp-=25+P.attr.INT+tot.ice; m.frozen=2; particles.push({x:m.x,y:m.y-10,text:'❄️',life:1,color:'#42a5f5'});}});
  }
  if(id==='triple'){
...
function updateCharScreen(){
  ...
  Object.entries(P.attr).forEach(([k,v])=>{
    ...
    d.innerHTML=\`<div class="attrName">\${k}</div><div class="attrVal">\${v}</div><div class="attrDesc">\${descs[k]}</div>\${P.attrPts>0?\`<div style="margin-top:6px;background:#FFD700;color:#000;font-weight:900;font-size:9px;padding:4px;border-radius:6px;border:2px solid #000;cursor:pointer;text-align:center" onclick="addAttr('\${k}')">+ ADICIONAR ( \${P.attrPts} pts)</div>\`:''}\`;
    grid.appendChild(d);
  });
...
function gp(e){
  ...
  let dx=cx-(r.left+r.width/2), dy=cy-(r.top+r.height/2), d=Math.hypot(dx,dy), m=38;
  if(d>m){let a=Math.atan2(dy,dx);dx=Math.cos(a)*m;dy=Math.sin(a)*m}
  return{dx,dy}
}
function jsS(e){e.preventDefault();J.a=1;T=null;document.getElementById('autoBanner').style.display='none'}
function jsM(e){if(!J.a)return;e.preventDefault();let {dx,dy}=gp(e);js.style.transform=\`translate(\${dx}px,\${dy}px)\`;J.x=dx/38;J.y=dy/38;if(Math.abs(J.x)>0.1)P.f=J.x>0?1:-1}
function jsE(){J.a=0;J.x=0;J.y=0;js.style.transform='translate(0,0)'}
jb.addEventListener('touchstart',jsS,{passive:false}); jb.addEventListener('touchmove',jsM,{passive:false}); jb.addEventListener('touchend',jsE);
...
cv.addEventListener('click',e=>{
  ...
  let clickedObj=objs.find(o=>{let ox=o.x-C.x, oy=o.y-C.y; return Math.hypot(ox-x,oy-y)<50;});
  if(clickedObj&&clickedObj.isDungeon){genDungeon(clickedObj.dungeonAct||act); showActTransition(act); quests.forEach(q=>{if(q.isDungeon&&q.act===act&&!q.done){q.done=1;P.gold+=q.r;document.getElementById('gold').textContent=P.gold; rq();}}); return;}
  if(clickedObj&&clickedObj.t==='exit'){inDungeon=false; genWorld(); showActTransition(act); return;}
  let clickedMer=merchants.find(m=>{let mx=m.x-C.x, my=m.y-C.y; return Math.hypot(mx-x,my-y)<50;});
  if(clickedMer){openShop(clickedMer); return;}
  T={x:C.x+x,y:C.y+y,id:null}; document.getElementById('autoBanner').style.display='block'; document.getElementById('autoBanner').innerHTML=\`🚶 Indo... <span class="cancel" id="cancelAuto2">CANCELAR ✕</span>\`;
  document.getElementById('cancelAuto2').onclick=()=>{T=null;document.getElementById('autoBanner').style.display='none'};
});
document.getElementById('attackBtn').onclick=()=>doAttack();
document.getElementById('potionBtn').onclick=()=>{
  let it=inv.find(x=>x.id==='potion_hp'&&x.count>0);
  if(it){it.count--; if(it.count<=0) inv[inv.indexOf(it)]={id:'empty',name:'',icon:'',type:'empty',count:0,weight:0}; P.hp=Math.min(P.maxHp,P.hp+50); updateBars(); ri();}
};
document.getElementById('charBtn').onclick=()=>{document.getElementById('charScreen').style.display='flex'; updateCharScreen();};
document.getElementById('shopBtnTop').onclick=()=>openShop();
...
document.querySelectorAll('.spell').forEach(el=>{el.onclick=()=>{let sid=el.dataset.skill; if(sid) doSkill(sid);};});
...
document.querySelectorAll('.classCard').forEach(c=>{
  c.onclick=()=>{
    document.querySelectorAll('.classCard').forEach(x=>x.classList.remove('selected'));
    c.classList.add('selected'); selClass=c.dataset.class;
  };
});

function startGame(){
  P.cls=selClass; let cls=CLASSES[P.cls];
  P.attr={...cls.base}; P.maxHp=80+cls.base.STA*2+cls.hp; P.hp=P.maxHp; P.maxMana=40+cls.base.INT*2+cls.mana; P.mana=P.maxMana; P.lvl=1; P.xp=0; P.gold=500; P.attrPts=0; P.skillPts=2; P.x=W/2; P.y=H/2;
...
function loop(now){
  ...
  if(mx||my){
    let tot=calcTotalStats();
    let speed=180+Math.floor(P.attr.DEX*2)+(tot.speed||0)*5;
  ...
  mons.forEach(m=>{
    ...
    if(dist<280){
      if(m.frozen>0){m.frozen-=dt;}
        ...
        let sp=m.isBoss?60:40+act*5;
        let nmx=m.x+Math.cos(ang)*sp*dt, nmy=m.y+Math.sin(ang)*sp*dt;
        if(!checkCollision(nmx,m.y,14)) m.x=nmx;
        if(!checkCollision(m.x,nmy,14)) m.y=nmy;
        if(dist<50&&m.atkCd<=0){
          let tot=calcTotalStats();
          let dmg=Math.max(1,(m.isBoss?25:8+act*2)-Math.floor(tot.def/3));
          ...
          if(P.hp<=0){P.hp=P.maxHp; P.x=W/2; P.y=H/2; P.gold=Math.max(0,P.gold-50); document.getElementById('gold').textContent=P.gold; showPopup('💀 Você morreu! -50 ouro','#ff5252');}
        }
      }
    } else if(m.w<=0){m.vx=(Math.random()-0.5)*40; m.vy=(Math.random()-0.5)*40; m.w=2+Math.random()*2;}
    if(m.w>0&&dist>=280&&!m.frozen){let nmx=m.x+m.vx*dt, nmy=m.y+m.vy*dt; if(!checkCollision(nmx,m.y,14)) m.x=nmx; if(!checkCollision(m.x,nmy,14)) m.y=nmy;}
  });
  summons.forEach((s,i)=>{
    ...
    if(target){let ang=Math.atan2(target.y-s.y,target.x-s.x); s.x+=Math.cos(ang)*80*dt; s.y+=Math.sin(ang)*80*dt; if(Math.hypot(s.x-target.x,s.y-target.y)<40&&s.atkCd<=0){target.hp-=15; s.atkCd=1; if(target.hp<=0){target.alive=false;target.respawn=8;}}}
  });
  projectiles.forEach((pr,i)=>{
    ...
    mons.forEach(m=>{if(m.alive&&Math.hypot(m.x-pr.x,m.y-pr.y)<30){m.hp-=pr.dmg; particles.push({x:m.x,y:m.y-15,text:\`-\${pr.dmg}\`,life:1,color:'#ff9800'}); projectiles.splice(i,1); if(m.hp<=0){m.alive=false;m.respawn=8; let g=10+act*3; P.gold+=g; document.getElementById('gold').textContent=P.gold;}}});
  ...
  if(boss){document.getElementById('bossBar').style.display='block'; document.getElementById('bossFill').style.width=(boss.hp/boss.max*100)+'%'; document.getElementById('bossName').textContent=\`👑 \${boss.bossName} Lv\${boss.level}\`;}
...
const styles = StyleSheet.create({
  ...
  webview: { flex: 1, backgroundColor: '#1a0f0a' },
});
